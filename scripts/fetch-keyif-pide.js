...
const OUTPUT_PATH = path.join(DATA_DIR, "keyif-pide.json");
const BACKUP_PATH = path.join(DATA_DIR, "keyif-pide.backup.json");
const SOURCE_URL = "https://www.bulurum.com/dir/pide-ve-lahmacun/";
