...
const OUTPUT_PATH = path.join(DATA_DIR, "keyif-cigkofte.json");
const BACKUP_PATH = path.join(DATA_DIR, "keyif-cigkofte.backup.json");
const SOURCE_URL = "https://www.bulurum.com/search/%C3%87i%C4%9F-K%C3%B6fte/";
