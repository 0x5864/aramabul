...
const OUTPUT_PATH = path.join(DATA_DIR, "keyif.json");
const BACKUP_PATH = path.join(DATA_DIR, "keyif.backup.json");
const SOURCE_URL = "https://www.bulurum.com/search/Meyhaneler/";
