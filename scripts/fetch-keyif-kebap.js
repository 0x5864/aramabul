...
const OUTPUT_PATH = path.join(DATA_DIR, "keyif-kebap.json");
const BACKUP_PATH = path.join(DATA_DIR, "keyif-kebap.backup.json");
const SOURCE_URL = "https://www.bulurum.com/search/Kebap%C3%A7%C4%B1lar/";
