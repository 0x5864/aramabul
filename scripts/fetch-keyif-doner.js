...
const OUTPUT_PATH = path.join(DATA_DIR, "keyif-doner.json");
const BACKUP_PATH = path.join(DATA_DIR, "keyif-doner.backup.json");
const SOURCE_URL = "https://www.bulurum.com/dir/donerciler/";
