...
const OUTPUT_PATH = path.join(DATA_DIR, "keyif-kahvalti.json");
const BACKUP_PATH = path.join(DATA_DIR, "keyif-kahvalti.backup.json");
const SOURCE_URL = "https://www.bulurum.com/search/Kahvalt%C4%B1-Mekanlar%C4%B1/";
